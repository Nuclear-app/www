      ...
      <div className="px-5 sm:px-8 md:px-16 lg:px-28 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="text-3xl font-bold mb-4">Nuclear</div>
            <p className=" mb-6 max-w-md">
              Transform your notes into interactive learning experiences with AI-powered tools. 
              Join thousands of students who are already learning smarter with Nuclear.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="https://app.dover.com/jobs/nuclear" target="_blank" className=" transition-colors">Careers</a></li>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className=" text-sm mb-4 md:mb-0">
            © 2025 Logiciels Nuclear Inc. All rights reserved.
          </div>
          <div className="flex space-x-6 text-sm">
            {/* <a href="/privacy" className=" transition-colors">Privacy Policy</a> */}
